...
class CreateDoorkeeperTables < ActiveRecord::Migration[7.2]
  def change
    create_table :oauth_applications do |t|
      ...
      # Remove null: false on the redirect_uri for oauth_applications table.
      # As we are using the OAuth for API authentication, we won’t need to redirect the user to a callback page
      # (like after you sign in with Google / Apple / Facebook on an app, they will redirect to a page usually).
      t.text    :redirect_uri
